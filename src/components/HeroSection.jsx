    ...
    <div className="relative z-10">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-10 text-center relative z-10">
        <div className="relative inline-flex items-center justify-center mb-4 sm:mb-6">
          ...
          {/* Removed glowing ring gradient */}
          <span className="inline-flex items-center px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-medium text-blue-700 border border-blue-200/50 relative z-10">
        ...
        <h2
          className="text-xl sm:text-3xl md:text-5xl lg:text-6xl font-bold text-blue-700 mb-6 sm:mb-10"
        ...
        <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-8 sm:mb-12">
          <span className="font-bold text-blue-700">Convert your code instantly with AI precision.</span> From Python to Java, 
          C++ to Go, and everything in between. Professional-grade conversions in seconds.
        </p>
        {/* Features Grid */}
