...
export const Footer = () => {
  return (
    <footer className="bg-white/60 backdrop-blur-xl border-t border-gray-200/30 mt-16 relative z-10">
      ...
      <div className="max-w-6xl mx-auto px-6 py-6 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <span className="flex items-center text-gray-500 text-sm md:text-base">
            Made with <Heart className="w-4 h-4 mx-1 text-red-500 animate-pulse" fill="currentColor" /> by <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 bg-clip-text text-transparent font-semibold ml-1">Akash</span>
          </span>
        </div>
      </div>
    </footer>
